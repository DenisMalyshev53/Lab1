...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if ((X-A)>0) { //случай когда объем ванны А меньше объема вливаемой в нее воды
            if ( (X-A)-B>0 ){ //случай когда объем ванны B меньше объема вливаемой в нее воды
                if ( ((X-A)-B)-C>0 ){ //случай когда объем ванны C меньше объема вливаемой в нее воды
                    if ( (((X-A)-B)-C)-D>=0 ){ //случай когда объем ванны D меньше или равен объему вливаемой в нее воды
                        System.out.println("Количество заполненных ванночек: 4");
                        System.out.print("Заполненные ванночки: A, B, C, D");
                    }
                    if ( (((X-A)-B)-C)-D<0 ){ //случай когда объем ванны D больше объема вливаемой в нее воды
                        System.out.println("Количество заполненных ванночек: 3");
                        System.out.print("Заполненные ванночки: A, B, C");
                    }
                }
                if ( ((X-A)-B)-C==0 ){ //случай когда объем ванны С равен объему вливаемой в нее воды
                    System.out.println("Количество заполненных ванночек: 3");
                    System.out.print("Заполненные ванночки: A, B, C");
                }
                if ( ((X-A)-B)-C<0 ){ //случай когда объем ванны С больше объема вливаемой в нее воды
                    System.out.println("Количество заполненных ванночек: 2");
                    System.out.print("Заполненные ванночки: A, B");
                }
            }
            if ( (X-A)-B==0 ){ //случай когда объем ванны B равен объему вливаемой в нее воды
                System.out.println("Количество заполненных ванночек: 2");
                System.out.print("Заполненные ванночки: A, B");
            }
            if ( (X-A)-B<0 ){ //случай когда объем ванны B больше объема вливаемой в нее воды
                System.out.println("Количество заполненных ванночек: 1");
                System.out.print("Заполненные ванночки: A");
            }
        }
        if ((X-A)==0) { //случай когда объем ванны равен объему вливаемой в неё воды
            System.out.println("Количество заполненных ванночек: 1");
            System.out.print("Заполненные ванночки: A");
        }
        if ((X-A)<0){ //случай когда объем ванны больше объема вливаемой в нее воды
